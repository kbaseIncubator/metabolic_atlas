...
from MetaboliteAtlasImpl import MetaboliteAtlas
impl_MetaboliteAtlas = MetaboliteAtlas(config)
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_MetaboliteAtlas.loadDictionary, name = 'MetaboliteAtlas.loadDictionary',
                             types = [dict])
        self.method_authentication[ 'MetaboliteAtlas.loadDictionary' ] = 'required'
                ...
                try:
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            err = ServerError()
                            err.data = "Authentication required for MetaboliteAtlas but no authentication header was passed"
                            raise err
